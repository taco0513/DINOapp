...
const formatDate = (date: Date | string, formatString: string = 'yyyy-MM-dd'): string => {
...
const getSchengenWindow = (referenceDate: Date | string = new Date()): { start: Date; end: Date } => {
  const end = typeof referenceDate === 'string' ? parseISO(referenceDate) : referenceDate
...
describe('Date Utilities', () => {
  ...
  describe('getDateRangeOverlap', () => {
    it('should calculate overlap correctly', () => {
      // Complete overlap
      expect(getDateRangeOverlap('2024-06-01', '2024-06-10', '2024-06-01', '2024-06-10')).toBe(10)
      
      // Partial overlap
      expect(getDateRangeOverlap('2024-06-01', '2024-06-10', '2024-06-05', '2024-06-15')).toBe(6)
      
      // One range inside another
      expect(getDateRangeOverlap('2024-06-01', '2024-06-30', '2024-06-10', '2024-06-20')).toBe(11)
    })

    it('should return 0 for non-overlapping ranges', () => {
      expect(getDateRangeOverlap('2024-06-01', '2024-06-10', '2024-06-11', '2024-06-20')).toBe(0)
      expect(getDateRangeOverlap('2024-06-11', '2024-06-20', '2024-06-01', '2024-06-10')).toBe(0)
    })

    it('should handle touching ranges', () => {
      // Ranges that touch at boundaries
      expect(getDateRangeOverlap('2024-06-01', '2024-06-10', '2024-06-10', '2024-06-20')).toBe(1)
    })
  })
