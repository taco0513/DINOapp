...
describe('Visa Requirements', () => {
    ...
    describe('Data consistency', () => {
      it('should have consistent data structure for all visa requirements', () => {
        ...
        testCases.forEach(([passport, destination]) => {
          const visa = getVisaRequirements(
            passport as PassportCountry,
            destination
          );
  ...
  describe('POPULAR_DESTINATIONS constant', () => {
    it('should contain popular destinations for each passport type', () => {
      const passportTypes: PassportCountry[] = [
        'KR',
        'US',
        'JP',
        'CN',
    ...
    it('should not contain duplicate destinations', () => {
      Object.entries(POPULAR_DESTINATIONS).forEach(
        ([passportType, destinations]) => {
  ...
  describe('Integration scenarios', () => {
    ...
    it('should handle visa requirements for business travelers', () => {
      ...
      const businessTravelers = [
        {
          passport: 'US' as PassportCountry,
          expectation: { visaRequired: false, hasKETA: true },
        },
        {
          passport: 'JP' as PassportCountry,
          expectation: { visaRequired: false, hasKETA: true },
        },
        {
          passport: 'CN' as PassportCountry,
          expectation: { visaRequired: true, hasKETA: false },
        },
      ];
