          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div>
              ...
              <p style={{ margin: 0, fontSize: '14px', opacity: 0.9 }}>
                {trip ? '날짜나 비자 정보를 업데이트할 수 있습니다' : '간단한 정보만 입력하면 자동으로 분석됩니다'}
              </p>
            </div>
            <button
              onClick={onCancel}
        ...
        <div style={{ padding: '24px' }}>
          ...
          {showHelp && (
            <div style={{
              ...
              <h4 style={{ margin: '0 0 8px 0', fontSize: '16px' }}>💡 빠른 팁</h4>
          ...
          {error && (
            <div style={{
              ...
              <AlertCircle style={{ height: '20px', width: '20px', color: 'var(--color-error)', flexShrink: 0, marginTop: '2px' }} />
          ...
          <div style={{ marginBottom: '32px' }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <h3 style={{ margin: 0, fontSize: '18px' }}>어디로 가셨나요?</h3>
                </div>
                  ...
                  >
                    ...
                    {COUNTRIES.map(country => (
                      <option key={country.code} value={country.name}>
                        {country.flag} {country.name} {country.isSchengen ? '🇪🇺' : ''}
                      </option>
                    ))}
                  </select>
                  {formData.country && COUNTRIES.find(c => c.name === formData.country)?.isSchengen && (
                    <div style={{
                      marginTop: '8px',
                      padding: '8px 12px',
                      backgroundColor: 'var(--color-primary-light)',
                ...
                <div style={{ paddingLeft: '44px' }}>
                  ...
                  {stayDuration && (
                    <div style={{
                      ...
                      <div>
                        <strong style={{ fontSize: '16px', color: 'var(--color-primary-dark)' }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <h3 style={{ margin: 0, fontSize: '18px' }}>비자 정보를 입력해주세요</h3>
                </div>
                ...
                <div style={{ paddingLeft: '44px' }}>
                  ...
                  <div style={{
                    ...
                    💡 <strong>팁:</strong> 무비자 입국은 Tourist를 선택하세요. 셰겐 지역은 90일이 기본값입니다.
                  </div>
                </div>
              </div>
              ...
              <div style={{
                ...
                <button
                  ...
                  style={{
                    ...
                    gap: '8px',
                    transition: 'all 0.2s',
                    boxShadow: loading ? 'none' : '0 2px 8px rgba(var(--color-primary-rgb), 0.3)'
                  }}
                  onMouseOver={(e) => {
                    if (!loading) {
                  ...
                  onMouseOut={(e) => {
                    if (!loading) {
                      ...
                      e.currentTarget.style.boxShadow = '0 2px 8px rgba(var(--color-primary-rgb), 0.3)'
                    }
                  }}
                >
                  {loading ? (
