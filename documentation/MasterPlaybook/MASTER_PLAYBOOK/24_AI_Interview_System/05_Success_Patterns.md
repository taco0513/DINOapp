...
```yaml
검증된 질문 시퀀스: 1. "어떤 상품을 판매하고 싶으신가요?"
...
```yaml
검증된 질문 시퀀스: 1. "현재 업무 프로세스에서 가장 비효율적인 부분은?"
...
```yaml
검증된 질문 시퀀스: 1. "어떤 사람들이 모여서 무엇을 공유하고 싶나요?"
