...
import { AuthMiddleware, securityMiddleware } from '@/lib/security/auth-middleware'
...
describe('Security Validation Tests', () => {
  ...
  describe('Authentication Middleware', () => {
    ...
    it('should detect suspicious activities', () => {
      ...
      const sqlReq = new NextRequest('http://localhost:3000/api/test?id=1;DROP TABLE users--')
      ...
      // XSS attempt
      const xssReq = new NextRequest('http://localhost:3000/api/test?name=<script>alert(1)</script>')
