...
const config = withPWA({
  ...
  runtimeCaching: [
    ...
    {
      urlPattern: /^https:\/\/dino-v2\.vercel\.app\/_next\/data\/.*/i,
    ...
    {
      urlPattern: /^https:\/\/dino-v2\.vercel\.app\/api\/.*/i,
      handler: 'NetworkFirst',
      method: 'GET',
      options: {
        cacheName: 'apis',
    ...
    {
      urlPattern: /\/(dashboard|schengen|visa-tracker)/i,
      handler: 'CacheFirst',
      options: {
