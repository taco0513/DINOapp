...
test.describe('Authentication E2E Tests', () => {
  ...
  test('should display login page for unauthenticated users', async ({
    ...
    const signInButton = page
      ...
      .or(page.locator('[href*="api/auth/signin"]'))
  ...
  test('should prevent access to trips page without authentication', async ({
    page,
  }) => {
  ...
  test('should prevent access to schengen calculator without authentication', async ({
    page,
  }) => {
  ...
  test('should prevent access to gmail integration without authentication', async ({
    page,
  }) => {
  ...
  test('should work with mock authentication for testing', async ({ page }) => {
    ...
    await expect(
      page.locator('text=로그아웃').or(page.locator('text=Logout'))
    ).toBeVisible();
  });
  ...
  test('should handle logout flow', async ({ page }) => {
    ...
    await expect(
      page.locator('text=로그아웃 중').or(page.locator('text=Sign in'))
