...
export const PERFORMANCE_CONFIG = {
  ...
  resourceHints: {
    ...
    prefetch: ['/dashboard', '/trips', '/schengen'],
  },
  ...
  criticalCss: {
    inline: true,
    minify: true,
    extract: ['app/globals.css', 'styles/mobile-touch.css'],
  },
  ...
  serviceWorker: {
    ...
    // Precache patterns
    precache: ['/', '/dashboard', '/offline', '/manifest.json'],
...
export function getPerformanceRating(
  ...
  const good =
    PERFORMANCE_THRESHOLDS.good[
      metric as keyof typeof PERFORMANCE_THRESHOLDS.good
    ];
  const needsImprovement =
    PERFORMANCE_THRESHOLDS.needsImprovement[
      metric as keyof typeof PERFORMANCE_THRESHOLDS.needsImprovement
    ];
