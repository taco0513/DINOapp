...
describe('RateLimiter', () => {
  ...
  describe('checkLimit', () => {
    ...
    it('should track multiple requests from same client', async () => {
      ...
      const trackingRequest = new NextRequest(
    ...
    it('should handle different clients separately', async () => {
      ...
      const differentRequest = new NextRequest(
        'http://localhost:3000/api/test',
        {
          headers: {
    ...
    it('should differentiate clients by user agent', async () => {
      ...
      const differentUARequest = new NextRequest(
        'http://localhost:3000/api/test',
        {
          headers: {
            'x-forwarded-for': '192.168.1.1',
  ...
  describe('applyRateLimit middleware', () => {
    ...
    it('should include rate limit headers', async () => {
      const headerTestRequest = new NextRequest(
        'http://localhost:3000/api/test',
        {
          headers: {
      ...
      const blockedResponse = await applyRateLimit(
        headerTestRequest,
        'general'
      );
  ...
  describe('Edge cases', () => {
    it('should handle concurrent requests', async () => {
      ...
      const concurrentRequest = new NextRequest(
        'http://localhost:3000/api/test',
        {
          headers: {
