...
describe('Schengen Calculator', () => {
  ...
  describe('validateFutureTrip', () => {
    ...
    it('should allow valid future trip', () => {
      ...
      const validation = validateFutureTrip(baseVisits, plannedEntry, plannedExit, 'France')
    ...
    it('should allow non-Schengen country trips', () => {
      ...
      const validation = validateFutureTrip(baseVisits, plannedEntry, plannedExit, 'United Kingdom')
  ...
  describe('getSafeTravelDates', () => {
    ...
    it('should find safe travel dates for short duration', () => {
      ...
      const duration = Math.ceil(
        (safeDates!.endDate.getTime() - safeDates!.startDate.getTime()) / (1000 * 60 * 60 * 24)
      ) + 1
