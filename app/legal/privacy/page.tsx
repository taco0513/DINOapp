        ...
        <div className='space-y-8 text-secondary'>
          <section>
            ...
            <p className='leading-relaxed mb-4'>
              DINO는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는
            ...
            <ul className='ml-6 space-y-2 list-disc'>
              <li>
                서비스 제공에 관한 업무 (회원 관리, 여행 기록 관리, 알림 서비스)
              </li>
              <li>
                민원사무 처리 (민원인의 신원 확인, 민원사항 확인, 사실조사를
                위한 연락·통지)
              </li>
          ...
          <section>
            ...
            <div className='space-y-4'>
              <p>
                DINO는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
              ...
              <div className='bg-background border border-border rounded-lg p-4'>
                ...
                <ul className='space-y-2'>
                  <li>
                    <strong>회원 기본정보</strong>: 회원 탈퇴 시까지
                  </li>
                  <li>
                    <strong>여행 기록 데이터</strong>: 회원 탈퇴 후 즉시 삭제
                  </li>
                  <li>
                    <strong>Google 연동 데이터</strong>: 연동 해제 시 즉시 삭제
                  </li>
                  <li>
                    <strong>로그 기록</strong>: 3개월 (보안 목적)
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section>
            ...
            <p className='leading-relaxed'>
              DINO는 원칙적으로 정보주체의 개인정보를 수집·이용 목적으로 명시한
          ...
          <section>
            ...
            <div className='space-y-4'>
              <p>
                DINO는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보
                처리업무를 위탁하고 있습니다:
              </p>
              ...
              <div className='bg-background border border-border rounded-lg p-4'>
                ...
                <ul className='space-y-2'>
                  <li>
                    <strong>Vercel Inc.</strong>: 웹사이트 호스팅 및 CDN 서비스
                  </li>
                  <li>
                    <strong>Google LLC</strong>: 사용자 인증 및 API 서비스
                  </li>
                  <li>
                    <strong>PlanetScale Inc.</strong>: 데이터베이스 서비스
                    (프로덕션)
                  </li>
                </ul>
              </div>
              ...
              <p>
                위탁계약 시 개인정보보호법 제26조에 따라 위탁업무 수행목적 외
          ...
          <section>
            ...
            <div className='space-y-4'>
              <p>
                정보주체는 DINO에 대해 언제든지 다음 각 호의 개인정보 보호 관련
                권리를 행사할 수 있습니다:
              </p>
              ...
              <div className='bg-warning/10 border border-warning/20 rounded-lg p-4 mt-4'>
                <p className='text-sm'>
                  <strong>권리 행사 방법:</strong> 설정 페이지에서 직접
                  수정하거나, 고객센터(contact@dino-app.com)로 서면, 전화,
                  전자우편 등을 통하여 하실 수 있으며 DINO는 이에 대해 지체 없이
                  조치하겠습니다.
                </p>
              </div>
            </div>
          ...
          <section>
            ...
            <div className='space-y-4'>
              <p>
                DINO는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
              ...
              <div className='grid md:grid-cols-2 gap-4'>
                <div className='bg-background border border-border rounded-lg p-4'>
                  ...
                  <p className='text-sm'>
                    ...
                    방침 및 기타 관련 법령에 따라 일정기간 저장된 후 혹은 즉시
                    파기됩니다.
                  </p>
                </div>
          ...
          <section>
            ...
            <p className='mb-4'>
              DINO는 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에
          ...
          <section>
            ...
            <div className='space-y-4'>
              ...
              <div className='bg-info/10 border border-info/20 rounded-lg p-4'>
                ...
                <ul className='ml-6 space-y-2 list-disc'>
                  <li>
                    <strong>Google OAuth 2.0</strong>: 사용자 인증 및 기본
                    프로필 정보 접근
                  </li>
                  <li>
                    <strong>Gmail API</strong>: 항공편 예약 확인서 등 여행 관련
                    이메일 스캔 (사용자 동의 시)
                  </li>
                  <li>
                    <strong>Google Calendar API</strong>: 여행 일정 조회 및
                    동기화 (사용자 동의 시)
                  </li>
                </ul>
              </div>
          ...
          <section>
            ...
            <div className='bg-background border border-border rounded-lg p-4'>
              <p className='mb-4'>
                DINO는 개인정보 처리에 대한 업무를 총괄해서 책임지고, 개인정보
              ...
              <div className='space-y-2'>
                ...
                <p>
                  • 연락처: 문의사항이 있으시면 이메일로 연락주시기 바랍니다.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className='space-y-3'>
              ...
              <div className='bg-background border border-border rounded-lg p-4'>
                <p>
                  <strong>본 방침은 2024년 7월 28일부터 시행됩니다.</strong>
                </p>
