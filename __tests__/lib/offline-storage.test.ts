...
describe('Offline Storage', () => {
  ...
  describe('initialization', () => {
    ...
    it('should create object stores during database upgrade', async () => {
      ...
      expect(mockUpgradeDB.createObjectStore).toHaveBeenCalledWith('trips', { keyPath: 'id' })
      expect(mockUpgradeDB.createObjectStore).toHaveBeenCalledWith('countries', { keyPath: 'code' })
      expect(mockUpgradeDB.createObjectStore).toHaveBeenCalledWith('apiCache', { keyPath: 'key' })
      expect(mockUpgradeDB.createObjectStore).toHaveBeenCalledWith('offlineQueue', { keyPath: 'id', autoIncrement: true })
    })
  })
  ...
  describe('trip management', () => {
    ...
    it('should save trips successfully', async () => {
      const mockTrips = [
        { id: '1', userId: 'user1', country: 'France', entryDate: '2024-01-01' },
        { id: '2', userId: 'user1', country: 'Germany', entryDate: '2024-02-01' }
      ]
    ...
    it('should add trip to offline queue', async () => {
      const tripData = { country: 'France', entryDate: '2024-01-01', userId: 'user1' }

      const addPromise = offlineStorage.addTripToQueue(tripData)
      
      expect(mockDB.transaction).toHaveBeenCalledWith(['offlineQueue'], 'readwrite')
  ...
  describe('country management', () => {
    it('should save countries', async () => {
      ...
      expect(mockDB.transaction).toHaveBeenCalledWith(['countries'], 'readwrite')
    ...
    it('should get countries', async () => {
      ...
      expect(mockDB.transaction).toHaveBeenCalledWith(['countries'], 'readonly')
      expect(mockObjectStore.getAll).toHaveBeenCalled()
  ...
  describe('API cache management', () => {
    it('should cache API response with TTL', async () => {
      ...
      expect(mockDB.transaction).toHaveBeenCalledWith(['apiCache'], 'readwrite')
    ...
    it('should return null for expired cache', async () => {
      ...
      const deleteSpy = jest.spyOn(offlineStorage, 'deleteCachedApiResponse').mockResolvedValue()
  ...
  describe('offline queue management', () => {
    it('should get offline queue', async () => {
      ...
      expect(mockDB.transaction).toHaveBeenCalledWith(['offlineQueue'], 'readonly')
      expect(mockObjectStore.getAll).toHaveBeenCalled()
