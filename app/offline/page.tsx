          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">저장된 여행 정보를 확인할 수 있습니다</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">캐시된 데이터로 일수 계산 가능</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">저장된 국가별 비자 요구사항</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">연결 복구 시 자동으로 동기화됩니다</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <p>홈 화면에 DINO를 추가하면 앱처럼 사용할 수 있고, 오프라인에서도 더 많은 기능을 사용할 수 있습니다.</p>
              </div>
            </div>
          </div>
        </div>
