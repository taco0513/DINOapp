...
describe('webVitals', () => {
  ...
  describe('reportWebVitals', () => {
    ...
    it('should work when web-vitals functions are not available', () => {
      ...
      (getCLS as jest.Mock).mockImplementationOnce(undefined)
      (getFID as jest.Mock).mockImplementationOnce(undefined)
      (getFCP as jest.Mock).mockImplementationOnce(undefined)
      (getLCP as jest.Mock).mockImplementationOnce(undefined)
      (getTTFB as jest.Mock).mockImplementationOnce(undefined)
    ...
    it('should handle metrics with needs-improvement ratings', () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith('[Web Vitals]', needsImprovementMetric)
    })
  })
})