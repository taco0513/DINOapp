...
import { DEFAULT_PREFERENCES, requestNotificationPermission } from '@/lib/notifications'
        ...
        <div className="space-y-4">
          <label className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-secondary">중요한 알림을 이메일로 받습니다</p>
            </div>
            <input
              type="checkbox"
          ...
          <label className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-secondary">브라우저에서 실시간 알림을 받습니다</p>
            </div>
            <input
              type="checkbox"
