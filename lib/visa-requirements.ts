...
const VISA_REQUIREMENTS: Record<string, Record<string, VisaRequirement>> = {
  KR: {
    ...
    FR: { visaRequired: false, visaType: 'Visa Waiver', maxStayDays: 90, notes: '셴겐 지역 180일 중 90일' },
    DE: { visaRequired: false, visaType: 'Visa Waiver', maxStayDays: 90, notes: '셴겐 지역 180일 중 90일' },
    ES: { visaRequired: false, visaType: 'Visa Waiver', maxStayDays: 90, notes: '셴겐 지역 180일 중 90일' },
    IT: { visaRequired: false, visaType: 'Visa Waiver', maxStayDays: 90, notes: '셴겐 지역 180일 중 90일' },
    NL: { visaRequired: false, visaType: 'Visa Waiver', maxStayDays: 90, notes: '셴겐 지역 180일 중 90일' },
    GB: { visaRequired: false, visaType: 'Visa Waiver', maxStayDays: 180 },
    CA: { visaRequired: false, visaType: 'eTA', maxStayDays: 180, notes: 'eTA 사전 신청 필요 (CAD $7)' },
    AU: { visaRequired: true, visaType: 'ETA', maxStayDays: 90, notes: 'ETA 온라인 신청 필요 (AUD $20)' },
    ...
    // 비자 필요 국가들
    CN: { visaRequired: true, visaType: 'Tourist Visa', maxStayDays: 30, notes: '관광 비자 필요' },
    IN: { visaRequired: true, visaType: 'e-Visa', maxStayDays: 30, notes: 'e-Visa 온라인 신청' },
    RU: { visaRequired: true, visaType: 'Tourist Visa', maxStayDays: 30, notes: '초청장 필요' },
  ...
  US: {
    // 미국 여권 기준 (예시)
    KR: { visaRequired: false, visaType: 'K-ETA', maxStayDays: 90, notes: 'K-ETA 사전 신청 필요' },
    JP: { visaRequired: false, visaType: 'Visa Waiver', maxStayDays: 90 },
  ...
  JP: {
    // 일본 여권 기준 (예시)
    KR: { visaRequired: false, visaType: 'K-ETA', maxStayDays: 90, notes: 'K-ETA 사전 신청 필요' },
    US: { visaRequired: false, visaType: 'ESTA', maxStayDays: 90, notes: 'ESTA 사전 신청 필요' },
    // ... 더 많은 국가들
  },
