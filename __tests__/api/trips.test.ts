...
describe('/api/trips API Integration Tests', () => {
  ...
  describe('PUT /api/trips', () => {
    ...
    it('should update existing trip', async () => {
      ...
      (prisma.countryVisit.update as jest.Mock).mockResolvedValue({
        ...mockTrip,
        ...updateData,
      });
  ...
  describe('DELETE /api/trips', () => {
    ...
    it('should return 404 for non-existent trip', async () => {
      ...
      const request = new NextRequest(
        'http://localhost:3000/api/trips?id=999',
        {
          method: 'DELETE',
        }
      );
  ...
  describe('Data Consistency', () => {
    it('should maintain data integrity across operations', async () => {
      ...
      (prisma.countryVisit.findUnique as jest.Mock).mockResolvedValue(
        createdTrip
      );
