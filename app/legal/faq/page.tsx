  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-surface border border-border rounded-lg p-8">
        <h1 className="text-3xl font-bold text-primary mb-8">자주 묻는 질문 (FAQ)</h1>
            ...
            <section key={categoryIndex}>
              ...
              <div className="space-y-6">
                {category.questions.map((item, questionIndex) => (
                  <div key={questionIndex} className="bg-background border border-border rounded-lg p-6">
                    ...
                    <div className="text-secondary leading-relaxed flex items-start">
                      <span className="text-success mr-3 flex-shrink-0 font-semibold">A.</span>
                      <p>{item.a}</p>
                    </div>
                  </div>
                ))}
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <div className="bg-background border border-border rounded-lg p-6">
            <h3 className="text-lg font-semibold text-primary mb-4">추가 도움이 필요하신가요?</h3>
            <div className="space-y-3 text-secondary">
              <p>
                위의 FAQ에서 원하는 답변을 찾지 못하셨다면, 언제든지 문의해주세요.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex items-center">
                  <span className="font-medium mr-2">📧 이메일:</span>
                  <a href="mailto:support@dino-app.com" className="text-primary hover:underline">
