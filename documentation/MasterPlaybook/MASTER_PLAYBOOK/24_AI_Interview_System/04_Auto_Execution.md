  ...
  async executeComplete(interviewContext) {
    ...
    try {
      ...
      executionResults.structured =
        await this.phaseExecutors.structured.execute(
          interviewContext,
      ...
      executionResults.development =
        await this.phaseExecutors.development.execute(interviewContext, {
          ...executionResults.immediate,
          ...executionResults.structured,
        });
      ...
      executionResults.deployment =
        await this.phaseExecutors.deployment.execute(interviewContext, {
          ...executionResults.immediate,
          ...executionResults.structured,
          ...executionResults.development,
        });
