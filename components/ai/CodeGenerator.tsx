...
export default function CodeGenerator() {
  ...
  const getTypeIcon = (type: GeneratedCode['type']) => {
    switch (type) {
      case 'component': return <Layout className="h-4 w-4" />;
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-sm font-medium mb-2 block">코드 타입</label>
            ...
            <div>
              <label className="text-sm font-medium mb-2 block">프레임워크</label>
            ...
            <Tabs defaultValue="code">
              ...
              <TabsContent value="code" className="space-y-4">
                <div className="relative">
                  <pre className="bg-muted p-4 rounded-md overflow-x-auto">
                    <code className="text-sm font-mono">{generatedCode.code}</code>
                  </pre>
              ...
              <TabsContent value="test">
                {generatedCode.testCode ? (
                  <pre className="bg-muted p-4 rounded-md overflow-x-auto">
                    <code className="text-sm font-mono">{generatedCode.testCode}</code>
                  </pre>
                ) : (
