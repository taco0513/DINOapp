...
import { TravelManager, createTravelManager, getUserTravelSummary, validateUserTrip } from '@/lib/travel-manager'
...
describe('TravelManager', () => {
  ...
  describe('createTrip', () => {
    ...
    beforeEach(() => {
      (getCountryByName as jest.Mock).mockReturnValue({ name: 'France', code: 'FR' })
    })
    ...
    it('should throw error for invalid country', async () => {
      ...
      await expect(
        travelManager.createTrip({ ...validTripData, country: 'InvalidCountry' })
  ...
  describe('getVisaRequirements', () => {
    ...
    it('should return default when not found', async () => {
      ...
      const result = await travelManager.getVisaRequirements('Korea', 'UnknownCountry')
...
describe('Utility Functions', () => {
  ...
  describe('getUserTravelSummary', () => {
    it('should return user travel summary', async () => {
      ...
      jest.spyOn(TravelManager.prototype, 'getTravelInsights').mockResolvedValue({
        summary: mockSummary,
        popularDestinations: [],
        travelPatterns: {
  ...
  describe('validateUserTrip', () => {
    it('should validate user trip', async () => {
      ...
      const result = await validateUserTrip('user123', 'France', '2024-06-01', '2024-06-10')
