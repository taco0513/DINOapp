...
export default function AIPairProgramming() {
  ...
  const [currentMode, setCurrentMode] = useState<'driver' | 'navigator'>(
    'navigator'
  );
    ...
    const initialSuggestions: AINavigation[] = [
      {
        type: 'architecture',
        suggestion:
          '컴포넌트를 Container/Presentation 패턴으로 분리하면 테스트와 재사용성이 향상됩니다.',
        confidence: 0.95,
                      ...
                      <CardContent className='p-3'>
                        <div className='flex items-start justify-between mb-2'>
                          <Badge variant='outline'>
                            ...
                            {suggestion.type === 'implementation' && (
          ...
          <div className='space-y-3'>
            ...
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='text-xs text-muted-foreground'>
                  AI에게 구현 의도와 목표를 명확히 설명하면 더 나은 제안을 받을
                  수 있음
                </p>
              </div>
            </div>
          ...
          <CardContent>
            <div className='space-y-3'>
              ...
              <div className='flex justify-between items-center'>
                ...
                <span className='font-medium'>
                  {session.metrics.linesWritten} 라인
                </span>
              </div>
              <div className='flex justify-between items-center'>
                <span className='text-sm text-muted-foreground'>
                ...
                <span className='font-medium'>
                  {session.metrics.suggestionsAccepted}개
                </span>
              </div>
              <div className='flex justify-between items-center'>
                <span className='text-sm text-muted-foreground'>
                ...
                <span className='font-medium'>
                  {session.metrics.errorsDetected}개
                </span>
              </div>
              <div className='pt-3 border-t'>
                ...
                <Progress
                  value={Math.min(session.metrics.productivityScore / 3, 100)}
                />
              </div>
            </div>
          </CardContent>
