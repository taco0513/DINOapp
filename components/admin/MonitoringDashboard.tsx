  ...
  const _checkAlerts = () => {
    ...
    if (health) {
      ...
      if (
        ...
        parseInt(health.checks.memory.heapUsed) > 400
      ) {
    ...
    if (metrics) {
      ...
      if (metrics.summary.avgResponseTime > 1000) {
        newAlerts.push(
          `Slow response time: ${Math.round(metrics.summary.avgResponseTime)}ms`
        );
      }
    }
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8'>
        ...
        <div className='card'>
          <div className='p-6'>
            ...
            <p className='text-sm text-secondary mt-1'>마지막 재시작 이후</p>
          </div>
        </div>
      </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8'>
          <div className='card'>
            <div className='p-6'>
              ...
              <p className='text-sm text-secondary mt-1'>전체 시간</p>
            </div>
          </div>
          ...
          <div className='card'>
            <div className='p-6'>
              ...
              <p className='text-sm text-secondary mt-1'>전체 요청 대비</p>
            </div>
          </div>
          ...
          <div className='card'>
            <div className='p-6'>
              ...
              <p className='text-sm text-secondary mt-1'>모든 엔드포인트</p>
            </div>
          </div>
          ...
          <div className='card'>
            <div className='p-6'>
              ...
              <p className='text-sm text-secondary mt-1'>지난 24시간</p>
            </div>
          </div>
        </div>
      )}
