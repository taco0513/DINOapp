      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
        <Card>
          ...
          <CardContent>
            ...
            <p
              className={`text-xs ${metrics.activeUsers.trend === 'up' ? 'text-green-600' : 'text-red-600'}`}
            >
              {metrics.activeUsers.trend === 'up' ? '↑' : '↓'}{' '}
              {metrics.activeUsers.change}% 이전 대비
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {formatCurrency(Number(metrics.revenue.value))}
            </div>
            <p
              className={`text-xs ${metrics.revenue.trend === 'up' ? 'text-green-600' : 'text-red-600'}`}
            >
              {metrics.revenue.trend === 'up' ? '↑' : '↓'}{' '}
              {metrics.revenue.change}% 이전 대비
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p
              className={`text-xs ${metrics.tripCount.trend === 'up' ? 'text-green-600' : 'text-red-600'}`}
            >
              {metrics.tripCount.trend === 'up' ? '↑' : '↓'}{' '}
              {metrics.tripCount.change}% 이전 대비
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {formatPercentage(Number(metrics.retentionRate.value))}
            </div>
            <p
              className={`text-xs ${metrics.retentionRate.trend === 'up' ? 'text-green-600' : 'text-red-600'}`}
            >
              {metrics.retentionRate.trend === 'up' ? '↑' : '↓'}{' '}
              {metrics.retentionRate.change}% 이전 대비
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {metrics.avgTripDuration.value}일
            </div>
            <p
              className={`text-xs ${metrics.avgTripDuration.trend === 'up' ? 'text-green-600' : 'text-red-600'}`}
            >
              {metrics.avgTripDuration.trend === 'up' ? '↑' : '↓'}{' '}
              {metrics.avgTripDuration.change}% 이전 대비
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {formatPercentage(Number(metrics.conversionRate.value))}
            </div>
            <p
              className={`text-xs ${metrics.conversionRate.trend === 'up' ? 'text-green-600' : 'text-red-600'}`}
            >
              {metrics.conversionRate.trend === 'up' ? '↑' : '↓'}{' '}
              {metrics.conversionRate.change}% 이전 대비
            </p>
          </CardContent>
        </Card>
      </div>
