...
describe('Notifications', () => {
  ...
  describe('formatNotification', () => {
    ...
    it('should use correct colors for different priorities', () => {
      ...
      const mediumPriority = { ...mockNotification, priority: 'medium' as const }
      const highPriority = { ...mockNotification, priority: 'high' as const }
      const criticalPriority = { ...mockNotification, priority: 'critical' as const }
    ...
    it('should use correct icons for different types', () => {
      ...
      const schengenWarning = { ...mockNotification, type: 'schengen_warning' as const }
      const tripReminder = { ...mockNotification, type: 'trip_reminder' as const }
