...
describe('OfflineApiClient Integration Tests', () => {
  ...
  describe('Schengen Calculation', () => {
    it('should calculate Schengen status online', async () => {
      ...
      (ApiClient.getSchengenStatus as jest.Mock).mockResolvedValue(
        mockApiResponse
      );
  ...
  describe('Network State Management', () => {
    ...
    it('should handle API failures gracefully', async () => {
      (ApiClient.getTrips as jest.Mock).mockRejectedValue(
  ...
  describe('Data Preloading', () => {
    ...
    it('should handle preload failures gracefully', async () => {
      (ApiClient.getCountries as jest.Mock).mockRejectedValue(
        new Error('Preload failed')
      );

      // Should not throw
      await expect(
        OfflineApiClient.preloadOfflineData()
