...
export const vercelTemplates = {
  ...
  ecommerce: {
    deployUrl:
      'https://vercel.com/new/clone?repository-url=https://github.com/vercel/commerce',
    features: [
...
export const netlifyTemplates = {
  ...
  hugo: {
    deployUrl:
      'https://app.netlify.com/start/deploy?repository=https://github.com/gohugoio/hugo',
    buildTime: '30초',
    features: [
      '매우 빠른 빌드 속도',
      '다국어 지원',
