      ...
      <div className='flex justify-between items-start mb-4'>
        <div>
          <h3 className='card-title flex items-center'>
            ...
            {country?.isSchengen && <span className='badge ml-2'>셰겐</span>}
          </h3>
          <p className='card-description'>{trip.visaType}</p>
        </div>

        <div className='flex gap-2'>
          <button onClick={() => onEdit(trip)} className='btn btn-sm btn-ghost'>
            수정
          </button>
          <button
        ...
        <div className='flex justify-between'>
          ...
          <span className='text-small font-semibold'>
            {exitDate ? (
              ...
              <span className='badge badge-success'>현재 체류 중</span>
            )}
          </span>
        </div>
      </div>
      ...
      <div className='stat mb-4'>
        <div className='flex justify-between items-center'>
          ...
          <div className='text-right'>
            <span className='font-bold text-lg'>{days}일</span>
