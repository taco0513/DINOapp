...
export default function WireframeTripCard({
  trip,
  onEdit,
  onDelete,
    ...
    <div className='card'>
      ...
      >
        <div>
          ...
          >
            {formatDate(trip.entryDate)} -{' '}
            {trip.exitDate ? formatDate(trip.exitDate) : '현재'}
          </p>
          <div
            style={{
              display: 'flex',
      ...
      <div style={{ display: 'flex', gap: 'var(--space-2)' }}>
        <button onClick={() => onEdit(trip)} className='btn btn-ghost btn-sm'>
          수정
        </button>
        <button
          onClick={onDelete}
