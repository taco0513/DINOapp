...
<meta name="description" content="복잡한 비자 규정을 자동으로 추적하고 여행 기록을 체계적으로 관리하는 디지털 노마드 필수 도구">
<meta name="keywords" content="디지털노마드, 비자추적, 셰겐, 여행관리, visa tracker">
```

### 2. Open Graph (TODO)
```html
<meta property="og:title" content="DINO - Digital Nomad Visa Tracker">
<meta property="og:description" content="비자 만료일 자동 추적, 셰겐 규정 준수 계산">
