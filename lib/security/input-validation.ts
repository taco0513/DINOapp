...
export const validationPatterns = {
  ...
  // Positive integer
  positiveInt: z.string().regex(/^\d+$/).transform(Number).or(z.number().int().positive()),
...
export const tripValidation = {
  create: z.object({
    ...
    purpose: z.enum(['tourism', 'business', 'family', 'education', 'medical', 'other']),
  ...
  update: z.object({
    ...
    purpose: z.enum(['tourism', 'business', 'family', 'education', 'medical', 'other']).optional(),
    notes: validationPatterns.safeString.optional(),
