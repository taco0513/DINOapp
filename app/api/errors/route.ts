...
function getTopErrors(errors: ErrorReport[]) {
  const errorCounts = new Map<
    string,
    { count: number; latestError: ErrorReport }
  >();
...
async function sendToErrorTrackingService(_error: ErrorReport) {
  try {
...
async function sendCriticalErrorAlert(_error: ErrorReport) {
  try {
