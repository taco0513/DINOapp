...
const mockCreateTravelManager = createTravelManager as jest.MockedFunction<typeof createTravelManager>
...
describe('/api/trips API Tests', () => {
  beforeEach(() => {
    ...
    require('@/lib/security/rate-limiter').applyRateLimit.mockResolvedValue(null)
  ...
  describe('GET /api/trips', () => {
    ...
    it('should handle query parameters correctly', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/trips?includeCompleted=true&includePlanned=false&limit=50&sortBy=country&sortOrder=asc')
      const response = await GET(request)
    ...
    it('should handle rate limiting', async () => {
      ...
      require('@/lib/security/rate-limiter').applyRateLimit.mockResolvedValue(rateLimitResponse)
  ...
  describe('POST /api/trips', () => {
    ...
    it('should create a new trip successfully', async () => {
      ...
      require('@/lib/security/input-sanitizer').sanitizeRequestBody.mockResolvedValue(validTripData)
    ...
    it('should validate required fields', async () => {
      ...
      require('@/lib/security/input-sanitizer').sanitizeRequestBody.mockResolvedValue(invalidData)
    ...
    it('should handle invalid request body', async () => {
      require('@/lib/security/input-sanitizer').sanitizeRequestBody.mockResolvedValue(null)
    ...
    it('should handle database creation errors', async () => {
      mockTravelManager.createTrip.mockRejectedValue(new Error('Database error'))
      require('@/lib/security/input-sanitizer').sanitizeRequestBody.mockResolvedValue(validTripData)
    ...
    it('should record business metrics on successful creation', async () => {
      ...
      expect(require('@/lib/monitoring/metrics-collector').businessMetrics.tripCreated)
  ...
  describe('Edge Cases & Security', () => {
    ...
    it('should sanitize input data correctly', async () => {
      ...
      require('@/lib/security/input-sanitizer').sanitizeRequestBody.mockResolvedValue(sanitizedData)
      mockTravelManager.createTrip.mockResolvedValue({ ...sanitizedData, id: '3', userId: '1' })
...
describe('Performance Tests', () => {
  ...
  it('should handle pagination parameters correctly', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/trips?limit=1&sortBy=createdAt&sortOrder=asc')
    const response = await GET(request)
    const data = await response.json()
