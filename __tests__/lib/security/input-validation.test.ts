    ...
    describe('countryCode', () => {
      it('should validate ISO country codes', () => {
        ...
        validCodes.forEach(code => {
          expect(() =>
            validationPatterns.countryCode.parse(code)
          ).not.toThrow();
        });
      });
  ...
  describe('userValidation', () => {
    ...
    describe('notificationSettings', () => {
      it('should validate notification settings', () => {
        ...
        expect(() =>
          userValidation.notificationSettings.parse(validSettings)
        ).not.toThrow();
      });
      ...
      it('should reject invalid reminder days', () => {
        ...
        expect(() =>
          userValidation.notificationSettings.parse(invalidSettings)
        ).toThrow();
      });
    });
  });
  ...
  describe('apiValidation', () => {
    describe('pagination', () => {
      ...
      it('should reject excessive limit', () => {
        ...
        expect(() =>
          apiValidation.pagination.parse(invalidPagination)
        ).toThrow();
      });
      ...
      it('should reject SQL injection in sortBy', () => {
        ...
        expect(() =>
          apiValidation.pagination.parse(maliciousPagination)
        ).toThrow();
      });
    });
