          ...
          {loading ? (
            ...
            <div>
              <EmptyState
                ...
                description={
                  filter === 'all'
                    ? '첫 번째 여행을 추가하여 비자 추적을 시작하세요'
                    : filter === 'schengen'
                      ? '셰겐 지역 여행을 추가하면 90/180일 규칙을 자동으로 계산합니다'
                  ...
                  >
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-8'>
                      ...
                      <div className='text-center p-6 bg-green-50 rounded-lg border border-green-100'>
                        ...
                        <p className='text-sm text-gray-600 text-center'>
                          셰겐 90/180일 규칙을 자동으로 계산하고 오버스테이
                          위험을 미리 알려드립니다
                        </p>
                      </div>
                      ...
                      <div className='space-y-6'>
                        <div>
                          ...
                          <p className='text-sm text-secondary'>
                            A: 셰겐 지역은 최근 180일 이내의 여행만 기록하면
                            됩니다. 다른 국가는 비자 유효기간 내의 여행을
                            기록하시면 좋습니다.
                          </p>
                        </div>
                        ...
                        <div className='pt-5 border-t border-gray-200'>
                          <h5 className='font-medium mb-2'>
                            Q: 현재 체류 중인 국가는 어떻게 표시하나요?
                          </h5>
                          <p className='text-sm text-gray-600'>
                            A: 출국 날짜를 비워두시면 현재 체류 중으로
                            표시됩니다. 출국하실 때 날짜를 업데이트해주세요.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className='flex items-start gap-4'>
                        ...
                        <div>
                          <h4 className='font-semibold mb-2'>
                            프로 팁: Gmail 연동으로 자동화하기
                          </h4>
                          <p className='text-sm mb-3'>
                            Gmail을 연동하면 항공권 이메일을 자동으로 분석해서
                            여행 기록을 생성합니다. 수동 입력 시간을 90% 이상
                            절약할 수 있어요!
                          </p>
                          <Button variant='outline' size='sm' asChild>
                            <a href='/settings'>Gmail 연동하기 →</a>
                          </Button>
                        </div>
                      </div>
                    </div>
                ...
                <div className='mb-8 p-6 rounded-lg bg-white border border-gray-200'>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-6'>
                    ...
                    <div>
                      ...
                      <p className='text-xs text-gray-600'>
                        셰겐 지역만 보기, 현재 체류 중인 국가만 보기 등 필터를
                        활용하세요.
                      </p>
                    </div>
                    <div>
                      ...
                      <p className='text-xs text-gray-600'>
                        대시보드에서 전체 여행 통계와 셰겐 사용 현황을 확인할 수
                        있습니다.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='pt-4 border-t border-gray-200'>
                    <div className='flex items-center gap-2'>
                      ...
                      <p className='text-sm text-gray-600'>
                        <strong>팁:</strong> Gmail을 연동하면 항공권 이메일에서
                        여행 정보를 자동으로 추출합니다.
                        <a
                          href='/settings'
